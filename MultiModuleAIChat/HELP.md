...
Main points: 
    1. use spring DI with @Qualifier for different chat model
    2. if we don't have correct api-key
        a. spring.ai.chat.client.enabled = false
        or
        b. @ConditionalOnProperty(name = "spring.ai.openai.api-key")